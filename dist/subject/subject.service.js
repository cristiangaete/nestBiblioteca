...
let SubjectService = class SubjectService {
    ...
    validationOwnerShip(subject, user) {
        if (user.role !== rol_enum_1.Role.ADMIN && subject.userEmail !== user.email) {
...
exports.SubjectService = SubjectService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(subject_entity_1.Subject)),
